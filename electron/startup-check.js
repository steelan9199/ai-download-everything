...
function resolveTool(configuredPath, name) {
  ...
  return { found: false, path: configuredPath || null, configuredWrong: !!configuredPath };
}

function checkDownloadDir(dir) {
  try {
...
module.exports = { run, resolveTool, findOnPath, checkDownloadDir, HELP };